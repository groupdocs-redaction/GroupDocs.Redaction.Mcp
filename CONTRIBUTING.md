...
Thanks for your interest in improving the GroupDocs.Redaction MCP server.
...
`.vscode/mcp.json` contains a `groupdocs-redaction-dev` entry that runs the server from
...
Use the [issue templates](https://github.com/groupdocs-redaction/GroupDocs.Redaction.Mcp/issues/new/choose).
