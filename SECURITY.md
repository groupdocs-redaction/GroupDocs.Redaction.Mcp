...
Only the **latest released version** of `GroupDocs.Redaction.Mcp` (NuGet / GHCR / Docker Hub)
...
- Use GitHub's [private vulnerability reporting](https://github.com/groupdocs-redaction/GroupDocs.Redaction.Mcp/security/advisories/new)
...
- Vulnerabilities in the underlying `GroupDocs.Redaction` engine (a closed-source NuGet
